            ...
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        <h1 class="mx-auto my-0 text-uppercase">Cafe</h1>
                        <h2 class="text-white-50 mx-auto mt-2 mb-5">Cafe Bandoengs alamat bangdung barat jalan soedirman bunderan kartini pertinggan belok kiri blok A39 dan A40.</h2>
        ...
        <section class="about-section text-center" id="about">
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8">
                        <h2 class="text-white mb-4">About Cafe</h2>
                        <p class="text-white-50">
                            Cafe ini terletak di dataran tinggi yang memungkinkan anda sebagai penikmat kofi bisa,nongkrong sambil melihat pemandangan indah dijamin deh kalau milih kafe ini kalian gabakalan nyesel
                            <a href="https://www.instagram.com/ryllzzv//">Instagram.</a>
                            disana kafe kita juga ada live musik dan staff staff ramah di kafe kita
                        </p>
                    </div>
                </div>
        ...
        <section class="projects-section bg-light" id="projects">
            <div class="container px-4 px-lg-5">
                ...
                <div class="row gx-0 mb-4 mb-lg-5 align-items-center">
                    <div class="col-xl-8 col-lg-7"><img class="img-fluid mb-3 mb-lg-0" src="img/view.jpg" alt="..." /></div>
                    <div class="col-xl-4 col-lg-5">
                        <div class="featured-text text-center text-lg-left">
                            <h4>Reservasi</h4>
                            <p class="text-black-50 mb-0">cara resevarsi atau booking pertama tama register dulu pada halaman menu sign out lalu login jika sudah pilih halaman menu lalu ikuti tata cara resevarsinya.</p>
                        </div>
                    </div>
                </div>
                <!-- Project One Row-->
                <div class="row gx-0 mb-5 mb-lg-0 justify-content-center">
                    <div class="col-lg-6"><img class="img-fluid" src="img/1.jpg" alt="..." /></div>
                    <div class="col-lg-6">
                        <div class="bg-black text-center h-100 project">
                            <div class="d-flex h-100">
                                <div class="project-text w-100 my-auto text-center text-lg-left">
                                    <h4 class="text-white">Apa aja sih yang ada di cafe?</h4>
                                    <p class="mb-0 text-white-50">disana ada banyak makanan terutamanya ada juga live musik dan staff staff yang ramah tamah tentunya.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row gx-0 justify-content-center">
                    <div class="col-lg-6"><img class="img-fluid" src="img/3.jpg" alt="..." /></div>
                    <div class="col-lg-6 order-lg-first">
                        <div class="bg-black text-center h-100 project">
                            <div class="d-flex h-100">
                                <div class="project-text w-100 my-auto text-center text-lg-right">
                                    <h4 class="text-white">Alamat</h4>
                                    <p class="mb-0 text-white-50">Alamatnya bandung barat jalan sodierman dekat pertigaan simpang belok kanan ada bacaan Cafe Bandoengs</p>
                                </div>
                            </div>
                        </div>
                    </div>
